# Problem 11.7 - By Integration of Moment Equation {.unnumbered}

![Figure 1: A cantilever beam is subjected to a uniform distributed load.](images/401.png){fig-alt="Picture with a cantilever beam being subjected to a uniform distributed load. The beam is of length 2L with the wall on the right side of the beam. A distributed load, w, is applied over the first L distance of the beam."}
