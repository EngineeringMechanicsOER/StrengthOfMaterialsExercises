# Problem 6.7 - Torsional Stress {.unnumbered}

![Figure 1: A bolt is tightened using a wrench.](images/282.png){fig-alt="Picture with a bolt being tightend using a wrench. The wrench is of length L and has a force F applied to it. The bolt has a diameter of d."}
