# Problem 11.27 - By Superposition {.unnumbered}

![Figure 1: A simply supported beam is subjected to a distributed load and a point force.](images/423.png){fig-alt="Picture with a simply supported beam subjected to a distributed load and a point force. The beam is of length 3L and the distributed load, w, is applied over the entire length. A point force, F, is applied a distance of 2L from the left end."}
