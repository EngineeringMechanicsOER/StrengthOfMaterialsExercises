# Problem 10.12 - Shear Stress {.unnumbered}

![Figure 1: A simply supported W10x60 I beam is subjected to a uniform distributed load.](images/379.png){fig-alt="Picture with a simply supported W10x60 I beam being subjected to a uniform distributed load. The beam has a length of L. The distributed load, w, is applied over the entire length of the beam."}
