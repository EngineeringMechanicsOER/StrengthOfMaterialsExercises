...
app_ui = ui.page_fluid(
    ...
    ui.input_text("answer1", "Your normal force in units of lb", placeholder="Please enter your shear force"),
    ui.input_text("answer2", "Your shear force in units of lb", placeholder="Please enter your normal force"),
    ui.input_text("answer3", "Your bending moment in units of lb-in", placeholder="Please enter your bending moment"),
...
def server(input, output, session):
    ...
    def _():
        ...
        instr1 = abs(P()*math.cos((106-theta())*math.pi/180))
        instr2 = abs(P()*math.sin((106-theta())*math.pi/180))
        instr3 = abs(P()*math.sin((106-theta())*math.pi/180)*(15+14*math.cos(70*math.pi/180))-P()*math.cos((106-theta())*math.pi/180)*14*math.sin(70*math.pi/180))
