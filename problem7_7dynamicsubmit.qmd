# Problem 7.7 - Internal Shear Force & Bending Moments by Equilibrium {.unnumbered}

![Figure 1: A beam is subjected to a distributed force loading.](images/311.png){fig-alt="Picture with a beam being subjected to a distributed force loading. The beam is curved from A to B with a radius of r. The beam is horiztonal from B to C with a length of L. A distributed load W is applied from B to C. Section aa is halfway between B and C."}
