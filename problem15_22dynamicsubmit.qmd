# Problem 15.22 - Effect of supports {.unnumbered}

![Figure 1: A column that is fixed at the bottom and pinned at the top is subjected to a point load.](images/632.png){fig-alt="Picture with a column that is fixed at the bottom and pinned at the top subjected to a point load. The column is of length L with an equilateral triangle cross section with a side lenght of a. The force, Pcr, is applied at the top of the column."}
...
def server(input, output, session):
    ...
    def _():
        ...
        instr = 2.046*math.pi**2*E()*I/((L()*12)**2)
