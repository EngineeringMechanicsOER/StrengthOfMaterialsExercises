# Problem 11.31 - By Superposition {.unnumbered}

![Figure 1: A cantilever beam is subjected to a uniform distributed load and an external moment.](images/428.png){fig-alt="Picture with a cantilever beam subjected to a uniform distributed load and an external moment. The beam is of length L with the moment applied counter clock wise at the right end. The uniform distributed load, w, is applied over the first 2L/5 of the beam."}
