# Problem 12.14 - Principal Stresses {.unnumbered}

![Figure 1: A state of stress.](images/513.png){fig-alt="Picture with a state of stress. Sigma_y is applied outwards and sigma_x is applied to the upper right and bottom left corners."}
