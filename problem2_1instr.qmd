...
![](images/138_solution_2.png){width="500"} $$F_{AB} = R=0\,N$$

![](images/138_solution_3.png){width="500"} $$F_{BC} = F_1=60\,N$$

![](images/138_solution_4.png){width="500"} $$F_{CD} = F_1-F_2=60\,N-20\,N=40\,N$$
:::
...
$$solution = max(|\sigma_{AB}|,|\sigma_{BC}|,|\sigma_{CD}|)$$ $$solution = max(0\,MPa,2.12\,MPa,5.09\,MPa)$$ $$solution = 5.09\,MPa$$
:::
