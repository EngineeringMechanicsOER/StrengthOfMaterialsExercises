...
![](images/138.png){width="500"} Problem Statement:
...
![](images/138_solution_1.png){width="500"} $$\Sigma F = 0 = R-F_1+F_2+F_3$$ Solving for R:

$$R = F_1-F_2-F_3= 60\,N-20\,N-40\,N=0\,N$$ The force in each bar must be found:

![](images/138_solution_2.png){width="400"} $F_{AB} = R=0\,N$

![](images/138_solution_3.png){width="400"} $F_{BC} = F_1=60\,N$

![](images/138_solution_4.png){width="400"} $$F_{CD} = F_1-F_2=60\,N-20\,N=40\,N$$
:::
...
$$solution = max(|\sigma_{AB}|,|\sigma_{BC}|,|\sigma_{CD}|)$$ $$solution = max(0\,MPa,2.12\,MPa,5.09\,MPa)$$ $$solution = 5.09\,MPa$$ \[Solution adapted from © Kurt Gramoll CC BY NC-SA 4.0\]
