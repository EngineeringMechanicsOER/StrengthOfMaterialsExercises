# Problem 15.17 - Effect of supports {.unnumbered}

![Figure 1: A fixed channel is used as a column and subjected to a force.](images/626.png){fig-alt="Picture with a fixed channel used as a column and subjected to a force. The channel has a length of L and the force, F, is applied downward at the top of it."}
