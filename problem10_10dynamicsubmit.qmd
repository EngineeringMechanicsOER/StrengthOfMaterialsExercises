# Problem 10.10 - Shear Stress {.unnumbered}

![Figure 1: A cross section of a circular beam.](images/375.png){fig-alt="Picture with a cross section of a circular beam. The beam has a radius of r."}
