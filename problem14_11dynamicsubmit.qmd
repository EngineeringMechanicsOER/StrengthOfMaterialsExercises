...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"A solid circular rod of length L = {L()} m and radius r = {r()} mm is subjected to load F = {F()} kN and torsional moment T = {T()} kN-m. Determine the absolute value of the maximum principal stress σ<sub>1</sub> at point A.")]
