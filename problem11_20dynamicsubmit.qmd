# Problem 11.20 - By Integration of the Moment Equation {.unnumbered}

![Figure 1: A cantilever beam is subjected to a uniform distributed load.](images/410.png){fig-alt="Picture with a cantilever beam being subjected to a uniform distributed load. The beam is of length 2L and is attached at the right wall. The distributed load, w, is applied over the first L distance of the beam."}
