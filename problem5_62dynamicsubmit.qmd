# Problem 5.62 {.unnumbered}

![Figure 1: Two solid bars are stacked on top of one another.](images/139.png){fig-alt="Picture with two solid bars stacked on top of one another. The aluminum bar is of length L2 and the steel bar is of length L1. The bars have a width of W and a thickness of t."}
