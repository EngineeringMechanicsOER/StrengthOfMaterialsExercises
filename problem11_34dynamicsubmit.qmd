# Problem 11.34 - By Superposition {.unnumbered}

![Figure 1: A cantilever beam is subjected to two unform distributed loads and a point force.](images/433.png){fig-alt="Picture with a cantilever beam being subjected to two uniform distributed loads and a point force. The beam is of length 2L with a rectangular cross section of base b and height h. The first uniform distributed load, w, is applied upwards over a length L from the left end. The second unform distributed load, w, is applied downwards over a length of L to 2L from the left end. The point force, F, is applied upwards a distance of 2L from the left end. The beam is attached to the wall on the left end."}
