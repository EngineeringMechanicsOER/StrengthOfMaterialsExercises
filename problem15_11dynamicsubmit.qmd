...
![Figure 1: A column with a square cross section supports a load.](images/612.png){width=300 fig-alt="A column of length L has a square cross section hxh and is subjected to force F."}
