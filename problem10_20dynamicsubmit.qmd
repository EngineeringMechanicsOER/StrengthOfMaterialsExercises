...
![Figure 1: A T-beam is constructed of two plywood sheets nailed together.](images/384.png){width=300 fig-alt="A T beam is made of two pieces nailed together. The base of the T is height h1 and width b1. The top of the T is height h2 and base b2."}
