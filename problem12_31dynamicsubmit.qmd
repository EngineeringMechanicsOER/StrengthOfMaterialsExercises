# Problem 12.31 - Mohr's Circle {.unnumbered}

![Figure 1: A state of stress.](images/531.png){fig-alt="Picture with a state of stress. Sigma_y is applied inwards and sigma_x is applied towards the upper left and bottom right corners."}
