...
![Figure 1: Two cylinders are stacked on top of each other.](images/139.png){fig-alt="Picture with two cylinders stacked on top of each other and two forces are applied at the top surface and at the joint between teh cylinders as shown." width="818"} \[Problem adapted from © Kurt Gramoll CC BY NC-SA 4.0\]
...
def server(input, output, session):
    ...
    def _():
        ...
        instr= (FA()*L1())/((math.pi*(5/2)**2)*E) + ((FB()+FA())*L2())/((math.pi*(3/2)**2)*E)
