# Problem 9.35 - Unsymmetric Bending {.unnumbered}

![Figure 1: A steel T beam is subjected to two moments.](images/492.png){fig-alt="Picture with a steel T beam being subjected to two moments. The top of the T beam is of length 10 cm, the stem of the T beam is 8 cm, and there is a uniform thickness of 2 cm for the T beam. Mz is applied counter clockwise and My is applied counter clockwise."}
