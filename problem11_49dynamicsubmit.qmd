# Problem 11.49 - Statically Indeterminate Beam Deflection {.unnumbered}

![Figure 1: A beam with three supports is subjected to two point loads.](images/451.png){fig-alt="Picture with a beam with three supports subjected to two point loads. The beam is of length 4L with force F applied downward a distance of L from the left end and force 2F applied a distance of 3L from the left end. The left end is supported by a pin with rollers a distance of 2L and 4L from the left end."}
