...
![Figure 1: A large column supports a cantilevered load.](images/482.png){fig-alt="A metal pole with a load of F leans at an angle. The metal pole has an x dimention of x, a y dimension of y, and a z dimension of 8m. The force F is applied in the negative z direction. The metal pole has a circular ring cross section with an outer radius of 10cm and an inner radius of 8cm."}
