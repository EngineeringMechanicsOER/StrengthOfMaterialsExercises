# Problem 9.14 - Bending Stress {.unnumbered}

![Figure 1: A wide flange W14x30 beam is subjected to a unform distributed load and a force.](images/356.png){fig-alt="Picture with a wide flange W14x30 beam subjected to a unform distributed load and a force. The beam has a length of L1+L2+L3. A force, F, is applied at the left end of the beam. There is a roller support a distance of L1 from the left end. The distributed load, w, begins a distance of L1+L2 from the left end and occurs over a distance of L3."}
