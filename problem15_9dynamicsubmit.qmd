# Problem 15.9 - Buckling & yield – Euler's formula {.unnumbered}

![Figure 1: A wood truss is loaded.](images/620.png){fig-alt="Picture with a wooden truss being subjected to a point load. The truss is a right triangle with a base of L1 and a height of L2. The truss is made of a cross section with base b and height h. The point load, F, is applied at the top right end of the truss."}
