# Problem 5.65 - Thermal Deformation {.unnumbered}

![Figure 1: A square steel bar is placed between two fixed walls.](images/237.png){fig-alt="Picture with a square steel bar placed between two fixed walls.The bar is of length 2L and is subjected to force F at a distance L from the left wall. The bar has a cross section of wxw."}
