# Problem 12.16 - Principal Stresses {.unnumbered}

![Figure 1: An element is subject to a state of stress.](images/515.png){fig-alt="Picture with an element being subject to a state of stress. Sigma_y is applied outwards and sigma_x is applied towards the upper right and bottom left corners."}
