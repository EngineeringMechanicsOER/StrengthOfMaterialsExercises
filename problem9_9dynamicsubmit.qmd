...
![Figure 1: A beam with a circular cross section is subjected to a uniform distributed load.](images/351.png){fig-alt="Picture with a beam with a circular cross section being subjected to a uniform distributed load. The beam has a length of L and the distributed load, w, is applied over the entire length. The beam is pinned at the left end (A) and the right end (B). The beam has a circular cross section with a radius of r."}
