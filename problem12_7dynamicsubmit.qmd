# Problem 12.7 - Equations {.unnumbered}

![Figure 1: An element in plane stress is subjected to stresses.](images/506.png){fig-alt="Picture with an element in plane stress subjected to stresses. Sigma_y is applied outwards, sigma_x is applied to the upper right corner, and the element is rotated at angle theta."}
