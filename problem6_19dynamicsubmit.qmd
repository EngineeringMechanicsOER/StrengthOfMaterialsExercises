# Problem 6.19 - Torsional Deformation {.unnumbered}

![Figure 1: A cantilever rod is subjected to an unknown torque.](images/280.png){fig-alt="Picture with a cantilever rod subjected to an unknown torque. The rod is of length L and has a radius of r."}
