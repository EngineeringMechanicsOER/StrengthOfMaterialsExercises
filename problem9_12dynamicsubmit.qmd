# Problem 9.12 - Bending Stress {.unnumbered}

![Figure 1: A cantilever beam is subjected to a triangular distributed load and a moment.](images/354.png){fig-alt="Picture with a cantilever beam being subjected to a triangular distributed load and a moment The beam is 10 meters long. The distributed load occurs over the first 6 meters of the beam with a peak of w0. A moment is applied clockwise at the right end. The beam has a rectangular cross section with a base of b and a height of h."}
