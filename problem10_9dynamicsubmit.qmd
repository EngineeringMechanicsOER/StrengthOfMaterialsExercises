# Problem 10.9 - Shear Stress {.unnumbered}

![Figure 1: A cantilever beam is subjected to a triangular distributed load.](images/374.png){fig-alt="Picture with a cantilever beam being subjected to a triangular distributed load. The beam is of length 2L. The triangular distributed load has a peak of w0 at L and is mirrored over the second half of the beam. The beam has a rectangular cross section of height h and a base b."}
