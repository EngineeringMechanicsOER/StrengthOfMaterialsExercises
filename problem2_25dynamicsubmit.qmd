# Problem 2.25 - Average Shear Stress {.unnumbered}

![Figure 1: A lap joint is constructed with layers.](images/173.png){fig-alt="Picture with a four layer lap joint subjected to force F. The lap joint is L mm long and w mm wide."}
