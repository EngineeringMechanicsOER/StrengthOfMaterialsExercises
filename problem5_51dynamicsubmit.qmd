# Problem 5.51 - Thermal Deformation {.unnumbered}


![Figure 1: A weight is placed on a tall brass bar.](images/223.png){fig-alt="A weight is placed on a tall brass bar. The brass bar has a circular cross section of diameter d." width="300"}
