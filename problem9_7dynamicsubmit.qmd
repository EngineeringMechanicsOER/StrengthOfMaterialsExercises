# Problem 9.7 - Bending Stress {.unnumbered}

![Figure 1: A cantilever beam is subjected to a triangular distributed load.](images/349.png){fig-alt="Picture with a cantilever beam being subjected to a triangular distributed load. The beam has a length of 2L. The triangular load has a peak of w0 and is mirroed on the left and right side of the beam over a length of L each. The beam has a rectangular cross section with a base of b and a height of h."}
