# Problem 11.4 - By Integration of Moment Equation {.unnumbered}

![Figure 1: A cantilever beam is subjected to the loading shown.](images/394.png){fig-alt="A cantilever beam of length L has a distributed load w applied. The distributed load is applied over the first 2L/3 of the beam, from point A to point B."}
