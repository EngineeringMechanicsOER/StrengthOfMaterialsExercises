# Problem 5.20 - Axial Deformation {.unnumbered}

![Figure 1: A force on a lever causes a force to compress a cylinder.](images/199.png){fig-alt="Picture with lever ABC causing a force at D to compress the cylinder. There is a 45 degree angle from B to member LAB and a 45 degree angle from B to member LBC."}
