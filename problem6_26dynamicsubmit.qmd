# Problem 6.26 - Torsional Stress {.unnumbered}

![Figure 1: Two steel circular rods are firmly welded together between two walls.](images/303.png){fig-alt="Picture with two steel cirular rods welded together between two walls. The left rod has a diameter of d1 and a length of 2L. The right rod has a diameter of d2 and a length of L. A torque T is applied at a distance of L from the left wall."}
