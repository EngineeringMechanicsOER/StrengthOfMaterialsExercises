# Problem 2.3 - Average Normal Stress {.unnumbered}

![Figure 1: A plastic cylindrical peg is constrained by a metal cap](images/144.png){fig-alt="Picture with a cylindrical peg constrained by a metal cap with a force applied to the plastic peg." width="896"} \[Problem adapted from © Kurt Gramoll CC BY NC-SA 4.0\]
