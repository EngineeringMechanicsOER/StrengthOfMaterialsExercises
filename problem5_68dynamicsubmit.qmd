# Problem 5.68 - Thermal Deformation {.unnumbered}

![Figure 1: A circular bar is placed between two walls.](images/240.png){fig-alt="Picture with a circular bar placed between two walls. The bar is of length L, the wall gap is delta, and the diameter of the bar is d."}
