...
app_ui = ui.page_fluid(
    ...
    ui.input_text("answer1", ui.span("Your answer for A", ui.tags.sub("y"), " in units of kN"), placeholder="Please enter Ay"),
    ui.input_text("answer2", ui.span("Your answer for M", ui.tags.sub("A"), " in units of kN-m"), placeholder="Please enter MA"),
...
def server(input, output, session):
    ...
    def _():
        ...
        if correct1 and correct2:
            ...
            check = f" {'correct for Ay and incorrect for M.'}"
        elif correct2:
            check = f"{'incorrect for Ay and correct for M.'}"
        else:
