# Problem 11.45 - Statically Indeterminate Beam Deflection {.unnumbered}

![Figure 1: A propped cantilever beam is subjected to a point force.](images/447.png){fig-alt="Picture with a propped cantilever beam subjected to a point force. The beam is of length 3L, mounted to the wall at the left end and supported by a roller a distance of 2L from the left end. A point force, F, is applied downward a distance of 3L from the left wall."}
