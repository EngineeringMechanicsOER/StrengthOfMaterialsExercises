# Problem 15.5 {.unnumbered}

![Figure 1: A frame secured to two supports is subjected to a load.](images/613.png){fig-alt="Picture with a frame secured to two supports subjected to a load. the frame is an isosceles triangle with sides of length L on the top and left sides. The force, F, is applied downward at the right end of the frame. The frame is secured by a pin at the top left and a roller on the bottom left."}
