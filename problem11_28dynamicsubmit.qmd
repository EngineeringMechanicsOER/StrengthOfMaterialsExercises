# Problem 11.28 - By Superposition {.unnumbered}

![Figure 1: A simply supported beam is subjected to a distributed load and two point forces.](images/423.png){fig-alt="Picture with a simply supported beam subjected to a distributed load and two point forces. The beam is of length 2L and the distributed load, w, is applied over the first L length. A point force, F, is applied a distance of L/2 from the left end and another point force, F, is applied a distance of 3L/2 from the left end."}
