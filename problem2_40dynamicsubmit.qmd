# Problem 2.40 - Bearing Stress {.unnumbered}

![Figure 1: A crate is supported by a structure as shown.](images/161.png){fig-alt="Picture with a crate of weight W being supported by a structure. The structure is triangular with a length of 18 in and a height of 10 in. Member DC is the hypotenuse of the triangle and has a height of h. The pin has a diameter of d and a thickness of t."}
