# Problem 2.26 - Average Shear Stress {.unnumbered}

![Figure 1: A rectangular hole punch is configured as shown.](images/174.png){fig-alt="Picture with a rectangular hole punch configured to punch a L by w hole through a plate of thickness t. The hole punch uses a force of F."}
