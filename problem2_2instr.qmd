...
<p align="center">
![](images/139_solution_1.png){width="500"}
</p>
$$\delta_A = \frac{F_A*L_1}{A_A*E}$$ $$\delta_A = \frac{500\,lb*3\,in}{19.63\,in^2*30*10^6\,psi}$$ $$\delta_A = 2.55*10^{-6}\,in$$ 
:::
::: callout-note
## Step 3
Now the deflection from B:
<p align="center">
![](images/139_solution_2.png){width="500"} 
</p>
$$\delta_B = \frac{F_B*L_2}{A_B*E}$$ $$\delta_B = \frac{200\,lb*4\,in}{7.07\,in^2*30*10^6\,psi}$$ $$\delta_B = 3.77*10^{-6}\,in$$ 
:::
::: callout-note
## Step 4

Solving for total deflection:
