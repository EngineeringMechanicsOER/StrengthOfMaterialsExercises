...
$$\delta = \frac{FL}{AE}$$ $$\delta_T = \delta_A+\delta_B$$ Areas for A and B need to be calculated:
...
$$\delta_B = \frac{F_B*L_2}{A_B*E}$$ $$\delta_B = \frac{200\,lb*4\,in}{7.07\,in^2*30*10^6\,psi}$$ $$\delta_B = 3.77*10^{-6}\,in$$ Solving for total deflection:
