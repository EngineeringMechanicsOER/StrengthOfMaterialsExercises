# Problem 11.46 - Statically Indeterminate Beam Deflection {.unnumbered}

![Figure 1: A beam supported by two walls is subjected to a triangular distributed load.](images/448.png){fig-alt="Picture with a beam supported by two wallls being subjected to a triangular distributed load. The beam is of length L. The triangular distributed load has a peak of w0 at the right end and is applied downward over the entire length of the beam."}
