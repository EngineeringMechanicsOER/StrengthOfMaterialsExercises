# Problem 15.16 - Effect of supports {.unnumbered}

![Figure 1: A wood post is subjected to a point force.](images/622.png){fig-alt="Picture with a wooden post being subjected to a point force. The post has a height of L and the force, F, is applied downward on the top of it. The post is made of a square cross section with side length a."}
