# Problem 2.29 - Average Shear Stress {.unnumbered}

![Figure 1: A circular hole punch is configured as shown.](images/178.png){fig-alt="Picture with a circular hole punch configured to punch a d diameter hole through a t thickness metal plate using applied force F."}
