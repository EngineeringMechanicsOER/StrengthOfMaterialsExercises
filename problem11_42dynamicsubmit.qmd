# Problem 11.42 - Statically Indeterminate Beam Deflection {.unnumbered}

![Figure 1: A beam is subjected to a point load.](images/442.png){fig-alt="Picture with a beam being subjected to a point load. The beam is of length 4L with a pin at the left end, a roller a distance of 2L from the left end, and another roller a distance of 4L from the left end. The force, F, is applied downward a distance of L from the left end."}
