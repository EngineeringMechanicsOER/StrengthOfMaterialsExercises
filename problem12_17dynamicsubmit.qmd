# Problem 12.17 - Principal Stresses {.unnumbered}

![Figure 1: A cantilever I beam supports a pont load.](images/517.png){fig-alt="Picture with a cantilever I beam supporting a point load. The beam is of length L and the point load, F, is applied at the right end."}
