# Problem 9.15 - Bending Stress {.unnumbered}

![Figure 1: A cantilever pipe is subjected to a triangular distributed load and a force.](images/358.png){fig-alt="Picture with a cantilever pipe being subjected to a triangular distributed load and a force. The pipe is 7 m long. The triangular distributed load has a peak of w0 and occurs over the first 4 m of the pipe. A force is applied downward a distance of 6 m from the left end of the pipe. The pipe has an outer radius of ro and an inner radius of ri."}
