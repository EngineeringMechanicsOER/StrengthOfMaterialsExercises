# Problem 14.3 - Eccentric Axial Loads {.unnumbered}

![Figure 1: A cube is subjected to a load on one of its corners.](images/488.png){fig-alt="Picture with a cube being subjected to a point load one of its corners. The cube has a length of L. The force, F, is applied downards on the upper right corner of the cube."}
