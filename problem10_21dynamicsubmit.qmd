...
![Figure 1: A beam is constructed from two pieces nailed together.](images/385.png){width=250 fig-alt="A beam has a rectangular cross section consisting of two rectangles nailed together. The top rectangle has height h2 and base b. The bottom rectangle has height h1 and base b."}
