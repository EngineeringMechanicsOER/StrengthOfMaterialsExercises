# Problem 2.30 - Average Shear Stress {.unnumbered}

![Figure 1: Two bolts are attached to an assembly with a force applied as shown.](images/179.png){fig-alt="Picture with two bolts of diameter d in an assembly undergoing a load F."}
