# Problem 11.30 - By Superposition {.unnumbered}

![Figure 1: A cantilever beam is subjected to two point forces.](images/427.png){fig-alt="Picture with a cantilever beam subjected to two point forces. The beam is of length L. The first point force, F, is applied a distance of L/2 from the wall. The second point force, F, is applied a distance of L from the wall."}
