# Problem 12.8 - Equations {.unnumbered}

![Figure 1: A point is subjected to the state of stress shown.](images/507.png){fig-alt="Picture with a point subjected to a state of stress. Sigma_y is applied outwards and sigma_x is applied towards the upper right and bottom left corners. The point is then rotated at an angle theta."}
