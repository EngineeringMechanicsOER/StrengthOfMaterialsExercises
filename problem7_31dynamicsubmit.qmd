# Problem 7.31 - Graphical methods for shear force & bending moment diagrams {.unnumbered}

![Figure 1: A beam is subjected to a distributed load.](images/337.png){fig-alt=" A beam of length a+2b is subjected to a distributed load, w, over a distance a. The beam has pin supports a distance of a, and a+b from the left end of the beam. "}
