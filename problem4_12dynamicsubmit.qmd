# Problem 4.12 - Poisson's Ratio {.unnumbered}

![Figure 1: A rectangular rod is pulled in tension in the x-direction.](images/216.png){fig-alt="A rectangular rod is pulled in tension in the x-direction by a load P. The bar deflects by δ[1] in the x-direction and δ[2] in the y-direction. The length in the x-direction is 5 in, and the length in the y direction is 1 in."}
