# Problem 6.21 - Torsional Deformation {.unnumbered}

![Figure 1: A solid cylinder is rigidly attached to a hollow cylinder.](images/285.png){fig-alt="Picture with a solid cylinder rigidly attached to a hollow cylinder. The hollow cylinder has a length of 5 cm, an outer radius of ro and an inner radius of r$_i$. The solid cylinder has a total length of 10 cm and a radius of r. A torque T is applied to the solid cylinder."}
