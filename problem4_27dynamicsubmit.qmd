# Problem 4.27 - Multiaxial Hooke's Law {.unnumbered}

![Figure 1: A ridgid block is subjected to uniform hydrostatic pressure on all surfaces.](images/210.png){fig-alt="Picture of a block undergoing hydrostatic pressure. The block is 15 cm in the Z direction, 30 cm in the X direction, and 5 cm in the Y direction."}
