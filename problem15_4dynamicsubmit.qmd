# Problem 15.4 - Buckling & Yield – Euler's Formula  {.unnumbered}

![Figure 1: A cantilever truss subjected to a point load.](images/608.png){fig-alt="Picture of a cantilever truss ABCDE subjected to a point load. The truss has member lengths of L for members AB, BC, and DE. The point force is applied downwards at point C. Members AB, BC, and DE are horizontal, members AD and BE and vertical, and members DB and EC are diagonal above the horizontal. The truss is connected on the left side to a pin at A and a roller at D."}
