# Problem 3.10 - Shear Strain {.unnumbered}

![Figure 1: A triangular plae is subjected to a shear strain.](images/655.png){fig-alt="Picture with a triangular plate subjected to a shear strain. The plate is an equilateral triangle with an original side length of L."}
...
def server(input, output, session):
    ...
    def _():
        ...
        NewHor = L()*math.sin(math.pi/3)/math.tan(ang)
        instr = NewHor-L()/2
