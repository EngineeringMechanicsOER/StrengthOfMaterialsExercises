# Problem 14.18 - General Combined Loads {.unnumbered}

![Figure 1: A cylindrical pressure vessel supported by pin joints.](images/567.png){fig-alt="Picture with a cylindrical pressure vessel being supported by pin joints. The vessel is of length L with an inner radius of 5 in and a thickness of 1/8 in."}
