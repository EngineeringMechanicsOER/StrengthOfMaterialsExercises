# Problem 5.39 - Statically Indeterminate Axial Loads {.unnumbered}

![Figure 1: A concrete post with six steel rebar rods embedded in the concrete supports a load. ](images/250.png){fig-alt="A concrete post with 6 steel rebar rods embedded in the concrete supports a load, F. The post has diameter d[c] and the rebar rods have diameter d[s]." width="250"}
