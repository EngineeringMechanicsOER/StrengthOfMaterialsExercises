# Problem 13.14 - Cylindrical {.unnumbered}

![Figure 1: A state of stress on the side of a tank.](images/504.png){fig-alt="Picture with a state of stress on the side of a tank. The state of stress is at angle theta from the horizontal."}
...
def server(input, output, session):
    ...
    def _():
        ...
        instr= (sigmax()+sigmay())/2+(sigmax()-sigmay())/2*math.cos(-*theta()*math.pi/180)+tauxy()*math.sin(-2*theta()*math.pi/180)
