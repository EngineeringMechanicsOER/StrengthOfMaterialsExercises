# Problem 10.23 - Shear Stress {.unnumbered}

![Figure 1: A built up box beam is subjected to a shear force.](images/389.png){fig-alt="Picture with a built up box beam being subjected to a shear force. The box has a height of 8 in and a width of 10 in. Nails are placed in the box 1 in from the bottom and 2in from the top on both sides. The spacing between nails on the side view is s The thickness of all wooden members is 1 in."}
