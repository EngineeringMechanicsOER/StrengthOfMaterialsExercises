...
![Figure 1: A horizontal T beam is subjected to a force loading.](images/313.png){fig-alt="Picture with a horizontal T beam being subjected to a force loading. The base of the beam is of length 2a and the top of the beam is of length 2b. A distributed load w0 is applied over a length of 2b."}
