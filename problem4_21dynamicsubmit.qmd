# Problem 4.21 - Thermal Strain {.unnumbered}

![Figure 1: A gymnasium roof is supported by open web steel bar joists.](images/661.png){fig-alt="Picture with a gymnasium roof supported by open web steel bar joists. The roof has a length of L."}
