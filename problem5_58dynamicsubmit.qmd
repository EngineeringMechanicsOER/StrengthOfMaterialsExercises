# Problem 5.58 - Thermal Deformation {.unnumbered}

![Figure 1: A long steel pipe is mounted between two fixed walls.](images/229.png){fig-alt="Picture of a long steel pipe mounted between two fixed walls."}
