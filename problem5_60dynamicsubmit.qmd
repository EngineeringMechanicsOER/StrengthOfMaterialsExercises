# Problem 5.60 - Thermal Deformation {.unnumbered}

![Figure 1: A square PVC plastic rod is placed between two fixed walls.](images/229.png){fig-alt="Picture of a square PVC plastic rod placed between two walls. The rod is of length L and has a cross setion of 4 cm by 4 cm with a square cut out of 2 cm by 2 cm."}
