# Problem 6.23 - Power Transmission & Gear Assemblies {.unnumbered}

![Figure 1: A lawnmower engine powers a winch supporting a load.](images/670.png){fig-alt="A lawnmower engine with a horsepower of hp has a radius of 0.5 in. This engine is being used to power a homemade winch of radius 3 in supporting a load of w." width="300"}
