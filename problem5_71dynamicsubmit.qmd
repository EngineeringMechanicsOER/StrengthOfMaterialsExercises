# Problem 5.71 - Thermal Deformation {.unnumbered}

![Figure 1: A weightless bar is supported by two posts.](images/243.png){fig-alt="Picture with a weightless bar supported on two posts. The left post is made of PVC with a height h and the right post is made of Polycarbonate with a height h. The bar is length L."}
