# Problem 5.73 - Thermal Deformation {.unnumbered}

![Figure 1: A cable is connected between two fixed surfaces.](images/253.png){fig-alt="Picture with a cable connected between two fixed surfaces. The cable is of length L."}
