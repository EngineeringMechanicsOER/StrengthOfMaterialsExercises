# Problem 12.6 - Equations {.unnumbered}

![Figure 1: A state of stress in a member.](images/503.png){fig-alt="Picture with a state of stress in a member. The plane a-a is applied at a 45 degree angle."}
