# Problem 6.20 - Torsional Deformation {.unnumbered}

![Figure 1: A load is applied to a bracket firmly attached to the wall.](images/283.png){fig-alt="Picture with a bracket firmly attached to the wall being subjected to a load. The bracket has a distance from the wall of a, a length of b, and is on a shaft of diameter d."}
