# Problem 5.16 - Axial Deformation {.unnumbered}

![Figure 1: A solid square and round bar are pulled as shown.](images/190.png){fig-alt="Picture with a solid square and round bar pullled in series. The square bar has a 1 in by 1 in cross section, is made of copper, and is of length L1. The round bar has a 0.75 in diameter, is made of aluminum and is of length L2. Force F1 is applied at the end of the copper bar and force F2 is applied at the end of the aluminum bar."}
