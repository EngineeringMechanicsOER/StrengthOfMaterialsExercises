...
app_ui = ui.page_fluid(
    ...
    ui.input_text("answer1", ui.span("Your answer for A", ui.tags.sub("y"), " in units of kip"), placeholder="Please enter Ay"),
    ui.input_text("answer2", ui.span("Your answer for B", ui.tags.sub("y"), " in units of kip"), placeholder="Please enter By"),
...
def server(input, output, session):
    ...
    def _():
        ...
        if correct1 and correct2:
            ...
            check = f" {'correct for Ay and incorrect for By.'}"
        elif correct2:
            check = f"{'incorrect for Ay and correct for By.'}"
        else:
