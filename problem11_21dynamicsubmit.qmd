# Problem 11.21 - By Integration of the Moment Equation {.unnumbered}

![Figure 1: A simply supported beam is subjected to a non uniform loading as shown.](images/416.png){fig-alt="Picture with a simply supported beam being subjected to a non unform loading. The beam is of length L and the non-uniform loading is defined as w. The beam has a cross section of C150x12."}
