# Problem 15.21 - Effect of supports {.unnumbered}

![Figure 1: A fixed-free semicircular column is subjected to a point load.](images/631.png){fig-alt="Picture with a fixed-free semicircular column subjected to a point load. The column has a length of L and a radius of r. The force, F, is applied downward on the top of the column."}
