# Problem 5.50 - Thermal Deformation {.unnumbered}


![Figure 1: A solid circular bar is between two fixed walls.](images/222.png){fig-alt="A solid circular bar is between two fixed walls with length L." width="300"}
